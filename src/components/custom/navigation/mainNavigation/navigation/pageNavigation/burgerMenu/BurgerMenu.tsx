...
// Components
import { StyledBurgerMenu, StyledBurgerMenuLine } from "./styledBurgerMenu";
...
const BurgerMenu = ({ isOpen, onClick }: BurgerMenuProps) => {
  ...
  return (
    <StyledBurgerMenu onClick={onClick} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
      <StyledBurgerMenuLine ref={lineOne} x1={25} y1={42} x2={75} y2={42} />
      <StyledBurgerMenuLine ref={lineTwo} x1={25} y1={50} x2={75} y2={50} />
      <StyledBurgerMenuLine ref={lineThree} x1={25} y1={58} x2={75} y2={58} />
    </StyledBurgerMenu>
  );
};
