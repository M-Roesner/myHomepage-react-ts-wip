  ...
  Backend: [
    ...
    },
    {
      ...
      description: [
        ...
        "Ich integriere derzeit aktiv eine MySQL-Datenbank in meine Homepage, um Daten effizient zu verwalten und abzufragen.",
      ],
      icon: "SiMysql",
      projectLinks: [
        { text: "Homepage mit React.js und TypeScript", route: "/project/personal/1" },
    ...
    },
    {
      ...
      description: [
        ...
        "Ich habe grundlegende Kenntnisse in Express.js, die es mir ermöglichen, Server und API-Endpunkte zu erstellen.",
        "Aktuell implementiere ich Express.js aktiv in meine neue Homepage.",
      ],
      projectLinks: [{ text: "Homepage mit React.js und TypeScript", route: "/project/personal/1" }],
      icon: "SiExpress",
    ...
    },
    {
      ...
      description: [
        ...
        "Ich bin gerade dabei, AJAX in meine neu erstellte Homepage zu integrieren.",
      ],
      projectLinks: [{ text: "Homepage mit React.js und TypeScript", route: "/project/personal/1" }],
      icon: "FaDatabase",
      addedDate: new Date("2024-01-28"),
